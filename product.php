                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                <img class="img-avatar img-rectangel" src="uploads/products/<?php echo $product['image']; ?>" alt="">
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="text-center"><?php if((int)remove_junk($product['quantity'])===0):?>
                                <span class="badge badge-danger bg-danger" style="background-color: #DC3545;">Out of Stock</span>
                                <?php else:?>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <a href="mark_sold_out.php?id=<?php echo $product['id'];?>" class="btn btn-warning btn-xs" title="Mark as Sold Out" data-toggle="tooltip">
