							...
							<table class="table-shopping-cart">
								...
								<?php foreach ($cartData as $prod): ?>
									<tr class="table_row">
										...
										<input type="hidden" name="" id="" class="price<?php echo $prod['id'] ?>"
					...
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
						...
						<div class="flex-w flex-t bor12 p-b-13">
							...
							<div class="size-209">
								<span class="mtext-110 cl2 ">
									₱<span class="maintotal">0</span>.00
								</span>
							</div>
						</div>
						...
						<div class="flex-w flex-t bor12 p-t-15 p-b-30">
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								...
								<div class="p-t-15">
									...
									<div class="flex-w">
										<div
											class="flex-c-m stext-101 cl2 size-115 bg8 bor13 hov-btn3 p-lr-15 trans-04 pointer updatebtm">
											Update Totals
										</div>
									</div>
						...
						<div class="flex-w flex-t p-t-27 p-b-33">
							...
							<div class="size-209 p-t-1">
								₱
								<span class="mtext-110 cl2 checkouttext">
									79.65
								</span>.00
							</div>
						</div>
